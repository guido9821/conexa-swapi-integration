...
public class PeopleServiceTest {
    ...
    public void findPeopleByIdExceptionTest() throws IOException {
        ...
        when(restTemplate.exchange(any(String.class), any(HttpMethod.class), any(), any(Class.class))).thenReturn(new ResponseEntity<String>("", HttpStatus.OK));
        when(MapperUtil.getObjectFromJson(any(), any())).thenThrow(new IOException("Error de prueba"));

        peopleServiceImpl.findPeopleById(1);
    }
